...
export default function LandingPage() {
  ...
  return (
    <main className="w-full font-sans bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 relative">
            ...
            <div className="relative group z-50">
              ...
              <div className="absolute left-0 mt-2 w-40 bg-white shadow-lg rounded-lg opacity-0 invisible 
                group-hover:opacity-100 group-hover:visible
                transform -translate-y-2 group-hover:translate-y-0
                transition-all duration-300 overflow-hidden"
              >
                <ul className="text-gray-700">
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Sound Sytem</li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Lightning</li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Kamera</li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Olahraga</li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">Lainnya</li>
                </ul>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
            ...
            <Link href="/register" className="text-white hover:text-gray-200">REGISTRASI</Link>
      ...
      <section className="max-w-6xl mx-auto py-12 md:py-16 px-4 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
        ...
        {/* TEXT */}
        <div>
          <h2 className="text-2xl font-bold mb-4 text-black">Kenapa Memilih BrowStuff</h2>
          <p className="text-gray-600 mb-4">
            Lagi cari platform peminjaman perlengkapan kegiatan kampus yang lengkap, mudah diakses, dan terpercaya?
            BrowStuff hadir sebagai solusi utama bagi mahasiswa.
          </p>
          <p className="text-gray-600 mb-4">
            Sistem ini dirancang untuk memenuhi kebutuhan peminjaman barang seperti kamera, HT, proyektor,
            perlengkapan dokumentasi, hingga alat acara lainnya.
          </p>
          <p className="text-gray-600">
            Semua katalog barang tersedia lengkap dengan harga, ketersediaan, dan detail barang.
          </p>
        </div>
      ...
      <div
        ...
        <div className="px-4 w-full">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="px-8 py-1.5 bg-[#393E46] border-4 border-white text-white text-sm rounded-full transition-colors hover:bg-[#2E3238]">Sewa
            </button>
          </div>
        </div>
      </div>
  ...
  >
    LEBIH LANJUT
      ...
      <h2 className="text-2xl font-bold mb-4 text-gray-800">Ingin Menjadi Vendor?</h2>
      <p className="text-gray-700 max-w-xl mx-auto mb-6">Daftarkan barang yang kamu miliki dan mulai hasilkan uang tambahan dengan menyewakannya.</p>
