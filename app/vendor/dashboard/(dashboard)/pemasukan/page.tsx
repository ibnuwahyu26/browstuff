    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg flex items-center gap-6 text-black">
          <div className="w-14 h-14 border-2 border-black rounded-xl flex items-center justify-center">
            <FileText size={26} />
          </div>
          <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg">
        ...
        <div className="bg-gradient-to-b from-gray-700 to-gray-800 rounded-xl p-6 relative">
          ...
          <div className="flex items-end justify-around h-56 border-b border-gray-600 ml-12">
            {chartData.map((data) => (
              <div key={data.label} className="flex items-end h-full w-10">
                <div
                  className="w-full bg-gradient-to-t from-[#00ADB5] to-cyan-700 rounded-t-lg"
