  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-800 via-slate-900 to-black px-4 py-8">
      ...
      <div className="w-full max-w-3xl h-[520px] bg-slate-700/50 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden flex">
        ...
        <div className="w-1/2 bg-[#222831] px-6 py-10 flex justify-center">
          
          {/* CARD FORM - BG ABU DALAM */}
          <div className="w-full max-w-xs bg-[#393E46] rounded-xl p-5 shadow-xl">
            
            {/* TITLE (SAMA DENGAN LOGIN) */}
            <h1 className="text-center text-3xl font-bold drop-shadow-[1px_4px_0px_#772B8B] mb-2">
            ...
            <div className="mb-1">
              ...
              <input
                type="text"
                className="w-full px-3 py-2 bg-transparent border-2 border-white rounded-md text-white text-xs focus:outline-none focus:border-cyan-400"
              />
            </div>
            ...
            {/* SIGN UP BUTTON (SAMA DENGAN LOGIN) */}
            <button className="w-full bg-white hover:bg-gray-100 text-[#00ADB5] font-bold py-2 rounded-md mb-1 text-xs transition">
              Sign Up
            </button>
        ...
        {/* ================= RIGHT SIDE - BRANDING ================= */}
        <div className="w-1/2 bg-[#00ADB5] flex flex-col items-center justify-center text-center">
          <div className="mb-3">
            <Image
              src="/OBJECTS.png"
              alt="Logo"
          ...
          <p className="text-1xl text-white font-medium">
            Ayo Memulai menyewa
            <br />
            barang di kami
          </p>
